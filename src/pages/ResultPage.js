                                    ...
                                    <div class="grid mx-2 mt-5">
                                        <div class="grid-item">
                                            <Link to="/singleresult">
                                                <div class="card">
                                                    <img class="card-img" src="https://cms.dailysocial.id/wp-content/uploads/2016/05/dota2.jpg" alt="" />
                                                    <div class="card-content">
                                                        <h1 class="card-header pb-4">{e.title}</h1>
                                                        <p class="card-text">{e.genre}</p>
                                                        <p class="card-text">{e.platform}</p>
